...
$students = [];
for ($reg = 713; $reg <= 890; $reg++) { //reg_no generating for mec & bec
    $students[] = [
        'reg' => $reg, 
        'pro_id' => 12, 
        'sess_id' => 21, 
...
for ($reg = 1036; $reg <= 1090; $reg++) { //reg_no generating for fec
    $students[] = [
        'reg' => $reg, 
        'pro_id' => 12, 
        'sess_id' => 21, 
...
foreach ($students as $student) {
    ...
    preg_match("/B.Sc. in Civil Engineering/", $result, $examMatch);
